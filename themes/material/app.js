...
// Changing the logo.
  ...
  html += `<div class="mdui-toolbar-spacer"></div>
    ...
    html += `<div class="mdui-toolbar-spacer"></div>
      <a href="https://open.spotify.com/playlist/300LpLFtocQtAfbSBVi7r5?si=yawnBRyTR-WOjk7lMQ-8KA" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'Radon Gas'}">
