...
function nav(path) {
  ...
  //   </a>`;
    ...
    html += `<div class="mdui-toolbar-spacer"></div>
      <a href="https://github.com/radonintro1234" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'Radon Gas'}">
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 335 335" enable-background="new 0 0 335 335" xml:space="preserve" class="mdui-icon" style="width:100%;height:100%;">
        <path
